(function (J, m) {
  typeof exports == "object" && typeof module == "object"
    ...
    ? define("SakanaWidget", [], m)
    : typeof exports == "object"
    ? (exports.SakanaWidget = m())
    : (J.SakanaWidget = m());
})(self, () =>
  (() => {
    "use strict";
    var et = {
            ...
            return (
              (u.toString = function () {
                return this.map(function (l) {
                  var n = "",
                    c = typeof l[5] != "undefined";
                  return (
                    l[4] && (n += "@supports (".concat(l[4], ") {")),
                    l[2] && (n += "@media ".concat(l[2], " {")),
                    c &&
                      (n += "@layer".concat(
              ...
              (u.i = function (l, n, c, d, V) {
                ...
                for (var x = 0; x < l.length; x++) {
                  ...
                  (c && F[v[0]]) ||
                    ...
                    n &&
                      (v[2] &&
                        (v[1] = "@media ".concat(v[2], " {").concat(v[1], "}")),
                      (v[2] = n)),
                    d &&
                      (v[4]
                        ? ((v[1] = "@supports ("
        ...
        624: (p) => {
          ...
          function f(n, c) {
            for (var d = {}, V = [], F = 0; F < n.length; F++) {
              var w = n[F],
                A = c.base ? w[0] + c.base : w[0],
                x = d[A] || 0,
                v = "".concat(A, " ").concat(x);
              d[A] = x + 1;
              var E = u(v),
              ...
              if (E !== -1) h[E].references++, h[E].updater(D);
              else {
                var Y = l(D, c);
                (c.byIndex = F),
                  h.splice(F, 0, { identifier: v, updater: Y, references: 1 });
              }
              V.push(v);
            }
            return V;
            ...
            var V = function (w) {
              if (w) {
                if (
                  w.css === n.css &&
                  w.media === n.media &&
                  w.sourceMap === n.sourceMap &&
                  w.supports === n.supports &&
                  w.layer === n.layer
                )
                  return;
                d.update((n = w));
          ...
          p.exports = function (n, c) {
            ...
            return function (F) {
              ...
              for (var v = f(F, c), E = 0; E < d.length; E++) {
                var D = d[E],
                  Y = u(D);
        ...
        990: (p) => {
          function h(l, n, c) {
            var d = "";
            c.supports && (d += "@supports (".concat(c.supports, ") {")),
              c.media && (d += "@media ".concat(c.media, " {"));
            var V = typeof c.layer != "undefined";
            V &&
              (d += "@layer".concat(
                c.layer.length > 0 ? " ".concat(c.layer) : "",
                " {"
              )),
              (d += c.css),
              V && (d += "}"),
...
/*# sourceMappingURL=data:application/json;base64,`.concat(
              ...
              n.styleTagTransform(d, l, n.options);
          }
          function u(l) {
        ...
        230: (p) => {
          function h(u, f) {
            if (f.styleSheet) f.styleSheet.cssText = u;
            else {
    ...
    function m(p) {
      ...
      var u = (J[p] = { id: p, exports: {} });
      return et[p](u, u.exports, m), u.exports;
    }
    (m.n = (p) => {
      var h = p && p.__esModule ? () => p.default : () => p;
      return m.d(h, { a: h }), h;
    }),
      (m.d = (p, h) => {
        for (var u in h)
          m.o(h, u) &&
            !m.o(p, u) &&
            Object.defineProperty(p, u, { enumerable: !0, get: h[u] });
      }),
      (m.o = (p, h) => Object.prototype.hasOwnProperty.call(p, h)),
      (m.nc = void 0);
    var M = {};
    return (
      (() => {
        ...
        var p = m(624),
          ...
          x = m(951),
          v = {};
        (v.styleTagTransform = A()),
          (v.setAttributes = d()),
          (v.insert = n().bind(null, "head")),
          (v.domAPI = f()),
          (v.insertStyleElement = F());
        var E = h()(x.Z, v);
        const D = x.Z && x.Z.locals ? x.Z.locals : void 0;
        var Y = [],
          Ft = function () {
          ...
          xt = function () {
            ...
            typeof ErrorEvent == "function"
              ? (r = new ErrorEvent("error", { message: rt }))
              : ((r = document.createEvent("Event")),
                r.initEvent("error", !1, !1),
                (r.message = rt)),
              window.dispatchEvent(r);
          },
          k;
        (function (r) {
          (r.BORDER_BOX = "border-box"),
        ...
        var L = function (r) {
          ...
          Yt = (function () {
            function r(t, e) {
              (this.inlineSize = t), (this.blockSize = e), L(this);
            }
            return r;
          })(),
          st = (function () {
          ...
          it = function (r) {
            ...
            var i = r,
              a = i.offsetWidth,
              o = i.offsetHeight;
            return !(a || o || r.getClientRects().length);
          },
          nt = function (r) {
            var t;
            if (r instanceof Element) return !0;
            var e =
              (t = r == null ? void 0 : r.ownerDocument) === null ||
              t === void 0
                ? void 0
                : t.defaultView;
            return !!(e && r instanceof e.Element);
          },
          At = function (r) {
            switch (r.tagName) {
              case "INPUT":
                if (r.type !== "image") break;
              case "VIDEO":
              case "AUDIO":
              case "EMBED":
              case "OBJECT":
          ...
          at = /auto|scroll/,
          St = /^tb|vertical/,
          Et = /msie|trident/i.test(R.navigator && R.navigator.userAgent),
          S = function (r) {
          ...
          ot = L({
            ...
            borderBoxSize: I(),
            contentBoxSize: I(),
            contentRect: new st(0, 0, 0, 0),
          }),
          ct = function (r, t) {
            if ((t === void 0 && (t = !1), Z.has(r) && !t)) return Z.get(r);
            if (it(r)) return Z.set(r, ot), ot;
            var e = getComputedStyle(r),
              s = P(r) && r.ownerSVGElement && r.getBBox(),
              i = !Et && e.boxSizing === "border-box",
              a = St.test(e.writingMode || ""),
              o = !s && at.test(e.overflowY || ""),
              W = !s && at.test(e.overflowX || ""),
              g = s ? 0 : S(e.paddingTop),
              C = s ? 0 : S(e.paddingRight),
              b = s ? 0 : S(e.paddingBottom),
              y = s ? 0 : S(e.paddingLeft),
              K = s ? 0 : S(e.borderTopWidth),
              _t = s ? 0 : S(e.borderRightWidth),
              $t = s ? 0 : S(e.borderBottomWidth),
              te = s ? 0 : S(e.borderLeftWidth),
              Ct = y + C,
              ft = g + b,
              $ = te + _t,
              tt = K + $t,
              wt = W ? r.offsetHeight - tt - r.clientHeight : 0,
              bt = o ? r.offsetWidth - $ - r.clientWidth : 0,
              ee = i ? Ct + $ : 0,
              re = i ? ft + tt : 0,
              G = s ? s.width : S(e.width) - ee - bt,
              T = s ? s.height : S(e.height) - re - wt,
              se = G + Ct + bt + $,
              ie = T + ft + wt + tt,
              yt = L({
                devicePixelContentBoxSize: I(
                  Math.round(G * devicePixelRatio),
                  Math.round(T * devicePixelRatio),
                  a
                ),
                borderBoxSize: I(se, ie, a),
                contentBoxSize: I(G, T, a),
                contentRect: new st(y, g, G, T),
              });
            return Z.set(r, yt), yt;
          },
          ht = function (r, t, e) {
            var s = ct(r, e),
              i = s.borderBoxSize,
          ...
          Lt = (function () {
            function r(t) {
              ...
              (this.target = t),
                ...
                (this.borderBoxSize = L([e.borderBoxSize])),
                (this.contentBoxSize = L([e.contentBoxSize])),
                (this.devicePixelContentBoxSize = L([
          ...
          lt = function (r) {
            if (it(r)) return 1 / 0;
            for (var t = 0, e = r.parentNode; e; ) (t += 1), (e = e.parentNode);
            return t;
          },
          Kt = function () {
            var r = 1 / 0,
            ...
            Y.forEach(function (o) {
              if (o.activeTargets.length !== 0) {
                ...
                o.activeTargets.forEach(function (C) {
                  var b = new Lt(C.target),
                    y = lt(C.target);
                  W.push(b),
                    (C.lastReportedSize = ht(C.target, C.observedBox)),
                    y < r && (r = y);
                }),
                  t.push(function () {
                    o.callback.call(o.observer, W, o.observer);
                  }),
          ...
          It = function () {
            var r = 0;
            for (ut(r); Ft(); ) (r = Kt()), ut(r);
            return Vt() && xt(), r > 0;
          },
          X,
          dt = [],
          Bt = function () {
            return dt.splice(0).forEach(function (r) {
              return r();
            });
          },
          Ot = function (r) {
          ...
          Mt = (function () {
            ...
            return (
              ...
              (r.prototype.observe = function () {
                ...
                document.body ? e() : R.addEventListener("DOMContentLoaded", e);
              }),
              (r.prototype.start = function () {
                ...
                this.stopped &&
                  ...
                  pt.forEach(function (e) {
                    return R.addEventListener(e, t.listener, !0);
                  }));
              }),
              (r.prototype.stop = function () {
                ...
                this.stopped ||
                  ...
                  pt.forEach(function (e) {
                    return R.removeEventListener(e, t.listener, !0);
                  }),
                  (this.stopped = !0));
              }),
              r
          ...
          Q = new Mt(),
          gt = function (r) {
            !q && r > 0 && Q.start(), (q += r), !q && Q.stop();
          },
          Zt = function (r) {
            return !P(r) && !At(r) && getComputedStyle(r).display === "inline";
          },
          qt = (function () {
            function r(t, e) {
              (this.target = t),
                (this.observedBox = e || k.CONTENT_BOX),
                (this.lastReportedSize = { inlineSize: 0, blockSize: 0 });
            }
            return (
              (r.prototype.isActive = function () {
                var t = ht(this.target, this.observedBox, !0);
                return (
                  Zt(this.target) && (this.lastReportedSize = t),
          ...
          mt = function (r, t) {
            for (var e = 0; e < r.length; e += 1)
              if (r[e].target === t) return e;
            return -1;
          },
          U = (function () {
            function r() {}
            return (
              (r.connect = function (t, e) {
                var s = new Nt(t, e);
                N.set(t, s);
              }),
              (r.observe = function (t, e, s) {
                var i = N.get(t),
                  a = i.observationTargets.length === 0;
                mt(i.observationTargets, e) < 0 &&
                  (a && Y.push(i),
                  i.observationTargets.push(new qt(e, s && s.box)),
                  gt(1),
                  Q.schedule());
              }),
              (r.unobserve = function (t, e) {
                var s = N.get(t),
                  i = mt(s.observationTargets, e),
                  a = s.observationTargets.length === 1;
                i >= 0 &&
                  (a && Y.splice(Y.indexOf(s), 1),
              ...
              (r.disconnect = function (t) {
                var e = this,
                  s = N.get(t);
                s.observationTargets.slice().forEach(function (i) {
          ...
          Ut = (function () {
            ...
            return (
              (r.prototype.observe = function (t, e) {
                if (arguments.length === 0)
                  throw new TypeError(
        ...
        function Xt(r) {
          ...
          return function (...a) {
            (e = a), t === null && (t = requestAnimationFrame(s(this)));
          };
        }
        function Ht(r, t, e = (window.devicePixelRatio || 1) * 2) {
          const s = t * e;
          (r.width = s), (r.height = s);
          const i = r.getContext("2d");
          return i
            ? (i.setTransform(1, 0, 0, 1, 0, 0), i.scale(e, e), i)
            : null;
        }
        const Qt = {
            size: 200,
        ...
        class _ {
          constructor(t = {}) {
            (this._lastRunUnix = Date.now()),
              ...
              (this._options = B(Qt)),
              (this._options = j(this._options, t)),
          ...
          static registerCharacter(t, e) {
            const s = B(e);
            let i = s.initialState.i;
            (i = Math.min(0.5, Math.max(0, i))),
              (s.initialState.i = i),
              (O[t] = s);
          }
          _updateLimit(t) {
            ...
            const s = t / 4,
              i = -s;
            this._limit = { maxR: e, maxY: s, minY: i };
          }
          _updateSize(t) {
            (this._options.size = t),
              ...
              (this._domCanvas.style.width = `${t}px`),
              (this._domCanvas.style.height = `${t}px`);
            const e = Ht(this._domCanvas, t);
          ...
          _updateDom() {
            ...
            (s.className = "sakana-widget-canvas"),
              (this._domCanvas = s),
              e.appendChild(s);
            const i = document.createElement("div");
            (i.className = "sakana-widget-main"),
              (this._domMain = i),
              e.appendChild(i);
            const a = document.createElement("div");
            (a.className = "sakana-widget-img"),
              (a.style.backgroundImage = `url('${this._image}')`),
              (this._domImage = a),
              i.appendChild(a);
            const o = document.createElement("div");
            (o.className = "sakana-widget-ctrl"),
              (this._domCtrl = o),
              this._options.controls && i.appendChild(o);
            const W = "sakana-widget-ctrl-item",
              g = document.createElement("div");
            (g.className = W),
              (g.innerHTML = Tt),
              (this._domCtrlPerson = g),
              o.appendChild(g);
            const C = document.createElement("div");
            (C.className = W),
              (C.innerHTML = Pt),
              (this._domCtrlMagic = C),
              o.appendChild(C);
            const b = document.createElement("a");
            (b.className = W),
              (b.href = "//github.com/dsrkafuu/sakana-widget"),
              (b.target = "_blank"),
              (b.innerHTML = Gt),
              (this._domCtrlGitHub = b),
              o.appendChild(b);
            const y = document.createElement("div");
            (y.className = W),
              (y.innerHTML = zt),
              (this._domCtrlClose = y),
              o.appendChild(y);
          }
          _calcCenterPoint(t, e, s, i) {
            const a = (Math.PI / 180) * t,
              o = Math.cos(a),
              W = Math.sin(a),
              g = W * e + o * s - W * i,
              C = o * e - o * i - W * s;
          ...
          _draw() {
            const { r: t, y: e } = this._state,
              { size: s, controls: i, stroke: a } = this._options,
              o = this._domImage,
              W = this._imageSize,
              g = this._domCanvasCtx,
              C = t * 1;
            (o.style.transform = `rotate(${t}deg) translateX(${C}px) translateY(${e}px)`),
              g.clearRect(0, 0, s, s),
              g.save(),
              g.translate(s / 2, s),
              ...
              (g.lineCap = "round"),
              g.beginPath(),
              i ? g.moveTo(0, -10) : g.moveTo(0, 10);
            const b = s - W / 2,
              { nx: y, ny: K } = this._calcCenterPoint(t, b, C, e);
            g.lineTo(y, -K), g.stroke(), g.restore();
          }
          _run() {
            ...
            let { r: s, y: i, t: a, w: o } = this._state;
            const { d: W, i: g } = this._state,
              C = Date.now();
            let b = g;
            const y = C - this._lastRunUnix;
            if (
              (y < 16 && (b = (g / this._frameUnix) * y),
              (this._lastRunUnix = C),
              (o = o - s * 2 - t),
              (s = s + o * b * 1.2),
              (this._state.w = o * W),
          ...
          _move(t, e) {
            const { maxR: s, maxY: i, minY: a } = this._limit;
            let o = t * this._state.s;
            (o = Math.max(-s, o)),
              (o = Math.min(s, o)),
              (e = e * this._state.s * 2),
              (e = Math.max(a, e)),
          ...
          _onMouseDown(t) {
            ...
            const i = (o) => {
                const W = this._domMain.getBoundingClientRect(),
                  g = W.left + W.width / 2,
                  { pageX: C, pageY: b } = o,
                  y = C - g,
                  K = b - s;
          ...
          _onTouchStart(t) {
            if ((t.preventDefault(), (this._running = !1), !t.touches[0]))
              return;
            const { pageY: e } = t.touches[0],
              s = e;
            (this._state.w = 0), (this._state.t = 0);
            const i = (o) => {
                if (!o.touches[0]) return;
                const W = this._domMain.getBoundingClientRect(),
                  g = W.left + W.width / 2,
                  { pageX: C, pageY: b } = o.touches[0],
                  y = C - g,
                  K = b - s;
                this._move(y, K);
              },
          ...
          nextCharacter() {
            const t = Object.keys(_.getCharacters()).sort(),
              s = (t.indexOf(this._char) + 1) % t.length,
              i = t[s];
          ...
          mount(t) {
            let e = null;
            if ((typeof t == "string" && (e = document.querySelector(t)), !e))
              throw new Error("Invalid mounting element");
            this._domEl = e;
            const s = e.parentNode;
            if (!s) throw new Error("Invalid mounting element parent");
            this._domImage.addEventListener("mousedown", this._onMouseDown),
              ...
              this._domCtrlMagic.addEventListener(
                "click",
              ...
              this._options.autoFit &&
                ...
                (this._resizeObserver = new Ut(
                  Xt((a) => {
                    !a || !a[0] || this._onResize(a[0].contentRect);
                  })
                )),
                this._resizeObserver.observe(this._domWrapper));
            const i = e.cloneNode(!1);
            return (
              i.appendChild(this._domWrapper),
              s.replaceChild(i, e),
              requestAnimationFrame(this._run),
              this
            );
          ...
          unmount() {
            this._domImage.removeEventListener("mousedown", this._onMouseDown),
              this._domImage.removeEventListener(
                "touchstart",
                this._onTouchStart
              ),
              this._domCtrlPerson.removeEventListener(
                "click",
                this.nextCharacter
              ),
              this._domCtrlMagic.removeEventListener(
                "click",
                this.triggetAutoMode
              ),
